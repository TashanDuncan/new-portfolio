    ...
    <div className="container">
        <div className="profile-teaser media flex-column flex-lg-row">
            ...
            <div className="media-body">
                <h2 className="name font-weight-bold mb-1">Tashan Duncan</h2>
                ...
                <div className="mb-4">
                    ...
                    <a className="btn btn-secondary mb-3" href="resume.html"><FontAwesomeIcon icon={faFileAlt} className="mr-2"/><span className="d-none d-md-inline">View</span> Resume</a>
                </div>
            </div>
            <img className="profile-image mb-3 mb-lg-0 ml-lg-5 mr-md-0" src={Image} alt="Image of Tashan"/>
        </div>
    </div>
</section>
)
