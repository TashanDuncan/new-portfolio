    ...
    <div className="container">
        <div className="profile-teaser media flex-column flex-lg-row">
            ...
            <div className="media-body">
                ...
                <div className="bio mb-4">I'm a aspiring web engineer who has a passion for building complex scalable web apps. I write about web development on <a className="link-on-bg" href="www.codingmugen.com">my blog</a>. When I'm not working on a project you will find me at the gym, playing computer games (Currently in love with Elden Ring) or feeding my unhealthy addiction to a Manga called Berserk! <br></br> 
                </div>
                <div className="bio mb-2">Check out my project <a className="link-on-bg" href="projects.html">portfolio</a> and <a className="link-on-bg" href="resume.html">online CV</a>.</div>
                <div className="mb-4">
                <Link className="btn btn-primary mr-2 mb-3" to="portfolio"><FontAwesomeIcon icon={faArrowAltCircleRight} className="mr-2"/><span className="d-none d-md-inline">View</span> Portfolio</Link> 
